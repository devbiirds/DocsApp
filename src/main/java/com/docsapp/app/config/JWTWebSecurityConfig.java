...
import com.docsapp.app.security.JwtTokenAuthorizationOncePerRequestFilter;
import com.docsapp.app.security.JwtUnAuthorizedResponseAuthenticationEntryPoint;
...
public class JWTWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf()
                ...
                .antMatchers(HttpMethod.GET,"/theatres/**").permitAll()
        // .antMatchers(HttpMethod.GET,"/theatres").hasAuthority("1");
              .antMatchers(HttpMethod.GET,"/user/**").permitAll()
                .antMatchers(HttpMethod.POST,"/api/theatres/**").hasAuthority("1");
